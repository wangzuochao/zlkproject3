...
import com.zlk.zlkproject.article.entity.*;
import com.zlk.zlkproject.article.mapper.ArticleCommentRefReplyMapper;
import com.zlk.zlkproject.article.mapper.ArticleMapper;
import com.zlk.zlkproject.article.mapper.ArticleRefCommentMapper;
import com.zlk.zlkproject.article.mapper.ArticleRefLabelMapper;
...
public class ArticleServiceImpl implements ArticleService {
  @Autowired
   ...
   @Autowired
    ...
    @Override
    public List<Article> findHotArticle(Integer programId) {
        List<Article> articleList = articleMapper.findHotArticle(programId);
        return articleList;
    }
